...
eFlow(tt)  = interp1(flow.Lock1.Flow_noAll.Date,flow.Lock1.Flow_noAll.Data,ISOTime(tt));
flow_diff = mFlow - eFlow;
...
oFlow(tt) = interp1(flow.Lock1.Flow.Date,flow.Lock1.Flow.Data,ISOTime(tt));
%flow_diff = mFlow - sFlow;
...
figure;plot(sFlow);hold on;plot(eFlow);hold on;plot(oFlow)