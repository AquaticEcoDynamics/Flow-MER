...
input_file = '../012_Coorong_Salt_Crk_Mouth_Channel_MZ3_Culverts11.2dm';
output_file = '../012_Coorong_Salt_Crk_Mouth_Channel_MZ3_Culverts1.2dm';

shpfile = 'GIS/Coorong_Zones.shp';
