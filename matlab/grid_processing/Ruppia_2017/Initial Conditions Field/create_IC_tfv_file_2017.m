...
sdate = datenum(2017,07,01);


IC = create_IC_matfile_2017(sdate);

grid = './014_Coorong_Salt_Crk_Mouth_Channel_MZ3_Culverts.2dm';
...
shp = shaperead('GIS/Coorong_IC.shp');
...
for i = 1:length(headers)
    ...
    if strcmpi(headers{i},'SAL') == 1
        inpol = inpolygon(X,Y,shp(1).X,shp(1).Y);
        interp.(headers{i})(inpol) = 35;
    end
...
fid = fopen(['init_conditions_2017_v2.csv'],'wt');
fprintf(fid,'ID,');
