...
datearray(:,1) = (sdate-1):15/(60*24):datenum(2015,12,31,11,59,00);
...
%     IC.(sites{i}).H.Y = Y;
    ...
    H = create_interpolated_dataset(fdata,varname,sites{i},'Surface',datearray);
