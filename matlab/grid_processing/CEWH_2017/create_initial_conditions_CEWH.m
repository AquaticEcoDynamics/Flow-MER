...
defaults = xlsread('Defaults_v3_BB_CEWH_2013_07.xlsx','B3:O100');

outfile = 'init_conditions_2013_07_CEWH.csv';
...
% fieldfile = 'Matfiles/lowerlakes.mat';
% 
% defaults = xlsread('Defaults_v3_BB_CEWH.xlsx','B3:O100');
% 
% outfile = 'init_conditions_2015_CEWH_Alex.csv';
% 
% grid = '001_RM_Wetlands_LL_Coorong_MZ.2dm';
% 
% [XX,YY,nodeID,faces,X,Y,ID] = tfv_get_node_from_2dm(grid);
